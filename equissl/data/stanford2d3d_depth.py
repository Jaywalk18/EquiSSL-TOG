...
from ..utils.paths import add_sphere_uformer_to_path, dataset_dir, sphere_uformer_data_dir
add_sphere_uformer_to_path()
from trimesh_utils import IcoSphereRef

from ..utils.sphere import erp_to_icosphere_grid

SPHERE_UFORMER_DATA = str(sphere_uformer_data_dir())
...
class Stanford2D3DDepth(Dataset):
    ...
    def __init__(
        ...
        super().__init__()
        self.data_dir = dataset_dir(data_dir, "STANFORD2D3D_PATH")
