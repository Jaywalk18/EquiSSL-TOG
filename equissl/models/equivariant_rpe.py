...
The finite average is invariant to the chosen cyclic gauge subgroup. Full
rotation robustness on the discretized mesh is evaluated empirically.
"""
...
from ..utils.paths import add_sphere_uformer_to_path
